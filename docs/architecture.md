...
<!--
TODO: update this section once there are actual plugins to reference
...
<!--
TODO: update and re-add this section when there's something to add
...
└── commands/
    └── full-stack-feature.md    # Coordinates multiple agents
```
